		...
		<div className="my-2 flex justify-center">
			<div className="relative w-20 h-20 minlg:w-28 minlg:h-28">
				...
				<div className="absolute w-4 h-4 minlg:w-7 minlg:h-7 bottom-2 -right-0">
					<Image src={image.tick} layout="fill" objectFit="contain" />
				</div>
			</div>
		</div>

		<div className="mt-3 minlg:mt-7 text-center felxCenter flex-col">
			<p className="font-poppins dark:text-white text-nft-black-1 font-semibold text-base">
				{creatorName}
			</p>
			<p className=" mt-1font-poppins dark:text-white text-nft-black-1 font-semibold text-base">
